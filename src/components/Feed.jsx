...
const Feed = () => {
  return (
    <Box flex={4} p={2}>
      <Post
        avatar="https://cdn-0.easydrawingtutorials.com/images/HomerSimpson/homer-simpson-step-last.jpg?ezimgfmt=ng:webp/ngcb2"
        title="Everybody together S2"
        date="March 14, 2022"
        src="https://i.pinimg.com/originals/b7/26/0e/b7260e36be4b3243cc86735f1f5659ab.png"
        description="This impressive meeting is a perfect party and a fun time to play together with your friends. All started with one cup of beer that Moes gave us for free, along mussels, if you like."
      />
      <Post
      ...
      <Post
        ...
        description="This impressive image is the  recrition of the Richard Avedon's famous 1957 photograph of Carmen dell'Orefice, did you like it?"
      />
      <Post
